...
export default function Navbar() {
  ...
  return (
    <header className="z-50 w-full bg-[#a1651f] sticky top-0 px-4 sm:px-6 lg:px-[15.62%] py-4 lg:py-7">
      <nav className="flex items-center justify-between relative">
        ...
        >
          FOOD<span className="text-[#6b4416]">IES</span>
        </Link>
        ...
        `}>
              ...
              <li key={item.name} className="w-full lg:w-auto text-center">
                <Link
                  ...
                  className={`block w-full lg:w-auto text-[16px] leading-6 ${
                    item.active ? "text-[#f7f5f2] font-bold" : "text-white"
          ...
          <div className="lg:hidden flex items-center gap-4 mt-6">
            <Link href="./search.png" className="text-yellow-900 hover:text-[#FF9F0D] transition-colors" aria-label="Search">
              <Search size={24} />
            </Link>
            <Link href="/User.png" className="text-white hover:text-[#FF9F0D] transition-colors" aria-label="User Profile">
              <User size={24} />
            </Link>
            <Link href="/Tote.png" className="text-white hover:text-[#FF9F0D] transition-colors" aria-label="Shopping Cart">
