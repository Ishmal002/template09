  ...
  return (
    <div className="bg-yellow-50 min-h-screen">
      ...
      <header className="bg-cover bg-center h-48 flex items-center justify-center" style={{ backgroundImage: 'url(/path/to/header-bg.jpg)' }}>
        <h1 className="text-3xl sm:text-5xl font-bold text-black tracking-wide">Shopping Cart</h1>
      </header>

      
      <main className="py-6 px-4 sm:px-6 md:px-16 lg:px-28">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-10 gap-6">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex items-center">
              ...
              <Button
                ...
                className="bg-yellow-900 text-white px-6 py-2 rounded-r font-semibold"
              >
                Apply
              </Button>
            </div>
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-blue-200 p-6 rounded-lg">
              ...
              <Button className="w-full bg-yellow-900 text-white mt-4 py-3 rounded font-semibold">
                Proceed to Checkout
              </Button>
            </div>
          </div>
